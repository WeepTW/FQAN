#!/usr/bin/env python3
"""Experiment 6 reference-aligned v6 evaluator.
...
PROTOCOL = "experiment6-reference-aligned-v6.0.1"
...
def method_metadata(config_path: Path, config: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "primaryScoreRole": "calibrated-main-analysis",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=REPO_ROOT / "config" / "experiment6_narrative2_evaluation_v6.json")
